...
public class CountryAdapter extends GroupListView.GroupAdapter {
	...
	public CountryAdapter(Context context, GroupListView view) {
		super(view);
		rawData = CountryUtils.getGroupedCountryList(context);
		initSearchEngine();
		search(null);
	}
...
//		}
	...
	public View getTitleView(int group, View convertView, ViewGroup parent) {
		if (convertView == null) {
			...
			tv.setTextColor(parent.getContext().getResources().getColor(R.color.smssdk_lv_title_color));
	...
	public View getView(int group, int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
            ...
            tv.setTextColor(parent.getContext().getResources().getColor(R.color.smssdk_lv_tv_color));
