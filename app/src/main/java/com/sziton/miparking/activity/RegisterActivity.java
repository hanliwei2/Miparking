...
public class RegisterActivity extends Activity{
    ...
    Handler mHandler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            int result = msg.arg2;
            Object data = msg.obj;
            Log.e("mobSmsRegister", "event=" + event+"-----------result=" + result+"-----------data=" + data);
            if (result == SMSSDK.RESULT_COMPLETE) {
                System.out.println("--------result"+event);
                //短信注册成功后，返回MainActivity,然后提示新好友
                if (event == SMSSDK.EVENT_SUBMIT_VERIFICATION_CODE) {//提交验证码成功
                    ToastUtil.shortToast(RegisterActivity.this,"提交验证码成功！");
                    ...
                    mySharedPreferences.setStringValue(Constants.REGISTER_PHONE,
                            ...
                            phone);//保存手机号
                    mySharedPreferences.setIntValue(Constants.REGISTER_OR_FORGETPWD,Constants.REGISTER_TAG);
                    ToastUtil.shortToast(RegisterActivity.this,"验证码已经发送！");
                    Intent authcodeIntent=new Intent();
                    authcodeIntent.setClass(RegisterActivity.this,AuthcodeActivity.class);
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(des)) {
                        ToastUtil.shortToast(RegisterActivity.this,des);
                        return;
                    }
                } catch (Exception e) {
    ...
    private void initView(){
        ...
        backRL= (RelativeLayout) findViewById(R.id.registerBackRL);
        countryTV= (TextView) findViewById(R.id.registerCountryTV);
        phoneET= (EditText) findViewById(R.id.registerPhoneET);
        registerIV= (ImageView) findViewById(R.id.registerNextIV);
    ...
    private void handleCountry(){
        ...
        countryIntent.setClass(RegisterActivity.this, CountryPageActivity.class);
    ...
    private void handleNext(){
        ...
        if(NetHelper.IsHaveInternet(this)){
            ...
            //手机号符合要求，获取验证码*/
            //注册短信handler,必须放到点击按钮里，之前放在onresume里会收不到回调
    ...
    View.OnClickListener listener=new View.OnClickListener() {
        ...
        public void onClick(View v) {
           switch(v.getId()){
               case R.id.registerBackRL:
                   handleBack();
                   break;

               case R.id.registerCountryTV:
                   handleCountry();
                   break;

               case R.id.registerNextIV:
                   handleNext();
                   break;
           }
        }
